...
from tobot.objects import Object, items, keys, update, values
from tobot.serials import dumps, loads
...
class TestObject(unittest.TestCase):
    ...
    def test_module(self):
        self.assertEqual(Object().__module__, "tobot.objects")
